...
class FindAllPostulantUseCaseTest {
    ...
    void findAllPostulant() {
        Postulant postulant1 = new Postulant("1", new DocumentUser(), "1990-02-10", "Peruano", "5555555");
        Postulant postulant2 = new Postulant("2", new DocumentUser(), "1990-10-10", "Boliviano", "7777777");
